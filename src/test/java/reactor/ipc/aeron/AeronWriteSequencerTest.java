...
public class AeronWriteSequencerTest {
    ...
    public void itSendsNewlyAddedPublisherAfterCurrentIsBackpressured() {
        ...
        new Condition(writeSequencer::isReady)
                .awaitTrue(TIMEOUT);
    ...
    public void itSendsNextEnqueuedPublisherAfterCurrentSignalsError() {
        ...
        Scheduler scheduler = Schedulers.single();
        Mono<Void> result1 = writeSequencer.add(
                Flux.merge(
        ...
        writeSequencer.add(ByteBufferFlux.from("I'm", "here").subscribeOn(scheduler)).subscribe(msg -> {}, th -> {});
